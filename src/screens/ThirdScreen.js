...
import order from '../assets/orderbg.png'
import order2 from '../assets/orderbg2.png'

const orders = [{number: "10111", image: order}, {number: "10112", image: order2}]
...
const ThirdScreen = ({ route }) => {
    ...
    const renderItem = ({ item }) => {
        return (
            <TouchableOpacity onPress={() => navigation.navigate("FourthScreen", {num: item.number})} style={{width: 'auto', height: 'auto'}}>
